...
export default function Modal() {
  ...
  return (
    <>
      ...
      >
        <div className="modal-content bg-white p-6 rounded-md px-16 py-10 w-[50vw]" ref={modalRef}>
          <div className="flex flex-row justify-center items-center text-center">
          <h4 className="text-2xl font-semibold  ">
            you have successfully added a product to your cart
          </h4>
          <button className="border-1 border-red-500 rounded-md px-4 py-2 cursor-pointer text-red-500 relative hover:bg-red-500 hover:text-white transition-colors ease-in-out duration-200" onClick={closeModal}>
            Close
          </button>
          </div>
          <div className="flex flex-row justify-between mt-8  ">
            <a href="/cart" class="flex hov">
            <div className="flex flex-row  bg-[var(--color-4)]/60 rounded-md p-4 border-2 border-[var(--color-4)] hover:bg-[var(--color-4)]/80 transition-colors ease-in-out duration-200" >
              <div class="flex flex-col justify-center content-center items-center w-24  text-center">
                <p>Explore more</p>
                  <img
            ...
            <div className="flex flex-row bg-[var(--color-2)]/60 rounded-md p-4 border-2 border-[var(--color-2)] hover:bg-[var(--color-2)]/80 transition-colors ease-in-out duration-200" > 
              <div class="flex flex-col justify-center content-center items-center w-24 text-center">
                <p>Check the cart</p>
                  ...
                  <img src="/assets/cart.svg" alt="cart" class="w-16 h-auto" />
              </div>
            </div>
          </a>
          <a href="/cart" class="flex hov">
            <div className="flex flex-row bg-[var(--color-3)]/60 rounded-md p-4 border-2 border-[var(--color-3)] hover:bg-[var(--color-3)]/80 transition-colors ease-in-out duration-200" >
              <div class="flex flex-col justify-center content-center items-center w-24 text-center">
                <p>see home</p>
                <img src="/assets/home.svg" alt="home" class="w-16 h-auto" />
              </div>
            </div>
          </a>
        </div>
